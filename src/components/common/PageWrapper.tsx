...
export default function PageWrapper({ children, className, ...props }: { children: React.ReactNode; className?: string; showQuote?: boolean }) {
    const commonClassName =
        'mx-auto flex min-h-[calc(100vh-136px)] w-full max-w-[1400px] flex-col px-6 md:px-8 lg:px-10 items-center gap-4 overflow-x-hidden overflow-y-scroll pb-4 mt-10'
    return (
