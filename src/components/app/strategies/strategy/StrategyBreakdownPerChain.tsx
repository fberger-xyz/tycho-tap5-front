...
import { cn, listTrades, listTradesByChain } from '@/utils'
import { StrategyChain } from './StrategyChain'
import { IconIds } from '@/enums/icons.enum'
import IconWrapper from '@/components/icons/IconWrapper'
import { Strategy } from '@/types'
import { ErrorTemplate, LoadingTemplate, NotFoundTemplate } from '../../shared/PlaceholderTemplates'
...
export default function StrategyBreakdownPerChain() {
    ...
    if (isLoading && !strategy) return <LoadingTemplate entryName="Strategy" />
    if (hasError && error) return <ErrorTemplate entryName="Strategy" />
    if (!strategy) return <NotFoundTemplate entryName="Strategy" />
